...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Sataako Lieksassa nyt?", {"intent": "current_external_information", "needs_web": True, "response_mode": "source_bounded_answer"}),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Mitä opit viimeksi?", {"intent": "normal_chat", "use_chat_context": True}, {"target_scope": "latest_internal_learning", "should_use_memory": True, "should_use_project_state": True, "should_use_chat_context": True}),
        ...
        ("Lieksan terveyskeskus osoite", {"intent": "current_external_information"}, {"target_scope": "external_local_info", "should_use_web": True}),
